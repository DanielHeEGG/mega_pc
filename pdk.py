...
class LAYERS(gf.technology.LayerMap):
    ...
    DEVICE_REMOVE: gf.typings.Layer = (1, 1)
    HANDLE: gf.typings.Layer = (2, 0)
    HANDLE_REMOVE: gf.typings.Layer = (2, 1)

    VIAS_ETCH: gf.typings.Layer = (10, 0)
    POLY: gf.typings.Layer = (11, 0)
    OXIDE: gf.typings.Layer = (12, 0)
    ...
    CAP_BACKSIDE: gf.typings.Layer = (23, 0)
